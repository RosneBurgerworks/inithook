...
{
public:
    void RegisterItem(const std::string &modelpath, k_EItemType type);
...
public:
    ItemManager();
    void RegisterModelMapping(const std::string &path, k_EItemType type);
    void RegisterSpecialMapping(ItemSpecialMapperFn fn);
    k_EItemType GetItemType(CachedEntity *ent);

    std::list<ItemSpecialMapperFn> specials;
