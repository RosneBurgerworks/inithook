 ...
 *  if you want to draw any imgui windows with this, do it between renderStart and
 *  renderEnd YOU CANNOT DO IT IN PAINT/PAINTTRAVERSE, buffers do not support imgui
 *  windows, only raw draw commands, so only draw in SwapWindow
 */
