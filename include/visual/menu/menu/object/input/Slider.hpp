...
public:
    ...
    static settings::RVariable<rgba_t> bar_fill_color;
};
...
public:
    ...
    void render() override
    {
        ...
        else
        {
            ...
            draw::Rectangle(bb.getBorderBox().left() + *SliderStyle::handle_width / 2, bb.getBorderBox().top() + (bb.getBorderBox().height - *SliderStyle::bar_width) / 2, offset, *SliderStyle::bar_width, option ? *SliderStyle::bar_fill_color : *style::colors::error);
            //auto offset = handleOffset() * (bb.getBorderBox().width - *SliderStyle::handle_width);
            ...
            // Handle outline
            //draw::RectangleOutlined(bb.getBorderBox().left() + offset, bb.getBorderBox().top(), *SliderStyle::handle_width, bb.getBorderBox().height, *SliderStyle::bar_border, 1);
        }
