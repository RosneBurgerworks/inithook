...
public:
    ...
    void Init(uintptr_t original, void *hook_func)
    {
        ...
        patch.reset(new BytePatch(original, std::experimental::make_array<uint8_t>(0xE9, foffset(rel_addr, 0), foffset(rel_addr, 1), foffset(rel_addr, 2), foffset(rel_addr, 3))));
        InitBytepatch();
    }
