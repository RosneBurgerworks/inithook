...
void EXPOSED_Epic_VACBypass_1337_DoNotSteal_xXx_$1_xXx_MLG()
{
    ...
    static BytePatch HostSecureServer(Host_IsSecureServerAllowed_addr, std::experimental::make_array<uint8_t>(0x55, 0x89, 0xE5, 0x83, 0xEC, 0x18, 0x31, 0xC0, 0x40, 0xC9, 0xC3));
    static BytePatch HostSecureServer2(Host_IsSecureServerAllowed2_addr, std::experimental::make_array<uint8_t>(0x31, 0xC0, 0x40, 0xC3));
