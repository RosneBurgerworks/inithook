...
static settings::RVariable<rgba_t> color_border{ "zk.style.checkbox.color.border", "ffaa00ff" };
static settings::RVariable<rgba_t> color_checked{ "zk.style.checkbox.color.checked", "804d00ff" };
static settings::RVariable<rgba_t> color_hover{ "zk.style.checkbox.color.hover", "ffae00a5" };
