...
static settings::RVariable<rgba_t> color_border{ "zk.style.input.key.color.border", "ffaa00ff" };
static settings::RVariable<rgba_t> color_background_capturing{ "zk.style.input.key.color.background.capturing", "804d00ff" };
...
void zerokernel::InputKey::render()
{
    ...
    {
        if (capturing)
            renderBackground(*color_background_capturing);
