...
static settings::RVariable<rgba_t> color_selected{ "zk.style.tab-button.color.selected.background", "804d00ff" };
static settings::RVariable<rgba_t> color_separator{ "zk.style.tab-button.color.separator", "ff9900ff" };
static settings::RVariable<rgba_t> color_hover_underline{ "zk.style.tab-button.color.hover.underline", "ffaa00ff" };
static settings::RVariable<rgba_t> color_selected_underline{ "zk.style.tab-button.color.selected.underline", "804d00ff" };
