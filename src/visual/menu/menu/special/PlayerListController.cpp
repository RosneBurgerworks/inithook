...
PlayerListController::PlayerListController(Table &table)
    : table(table)
{
}

void PlayerListController::setKickButtonCallback(
    PlayerListController::kick_callback_type callback)
{
    cb_kick = std::move(callback);
}


void PlayerListController::setOpenSteamCallback(
    PlayerListController::open_steam_callback_type callback)
{
    cb_open_steam = std::move(callback);
}

void PlayerListController::setChangeStateCallback(PlayerListController::change_state_callback_type callback)
{
    cb_change_state = std::move(callback);
}

void PlayerListController::handleMessage(zerokernel::Message &msg, bool is_relayed)
{
    if (is_relayed)
        return;
...
void PlayerListController::removeAll()
{
    table.removeAllRowsExceptFirst();
}

void PlayerListController::removePlayer(int id)
{
...
void PlayerListController::updatePlayerName(
...
void PlayerListController::updatePlayerLifeState(int id, bool dead)
{
...
void PlayerListController::updatePlayerTeam(int id, int team)
{
...
void PlayerListController::updatePlayerClass(int id, int classId)
{
...
void PlayerListController::updatePlayerState(int id, std::string state_string)
{
...
void PlayerListController::addPlayer(int id, PlayerListData data)
{
    ...
    if (trow)
    {
        ...
        if (username) {
            ...
            username->kv["name"] = data.name;
            username->kv["action"] = "change_name";
        }
        if (kick)
        {
            kick->kv["user_id"] = id;
...
void PlayerListController::changeRowColor(zerokernel::TRow *row, const rgba_t &color)
{
...
void PlayerListController::updateRow(zerokernel::TRow *row)
{
