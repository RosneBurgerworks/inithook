...
static settings::RVariable<rgba_t> color_background{ "zk.style.taskbar.color.background", "1d1d1dff" };
static settings::RVariable<rgba_t> color_border{ "zk.style.taskbar.color.border", "ff9900ff" };
