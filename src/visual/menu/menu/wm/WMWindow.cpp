...
static settings::RVariable<rgba_t> color_border{ "zk.style.window.color.border", "996600ff" };
static settings::RVariable<rgba_t> color_background{ "zk.style.window.color.background.active", "1d1d1dff" };
static settings::RVariable<rgba_t> color_background_inactive{ "zk.style.window.color.background.inactive", "1d1d1dff" };
...
WMWindow::WMWindow(WindowContainer &container) : BaseMenuObject{}, container(container)
{
    ...
    header_location.installChangeCallback([this](int after) {
