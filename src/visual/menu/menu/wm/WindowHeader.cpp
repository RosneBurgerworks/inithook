...
static settings::RVariable<rgba_t> color_background{ "zk.style.window-header.color.background.inactive", "1d1d1dff" };
static settings::RVariable<rgba_t> color_background_focused{ "zk.style.window-header.color.background.active", "000000ff" };
static settings::RVariable<rgba_t> color_border{ "zk.style.window-header.color.border.inactive", "ffaa00ff" };
static settings::RVariable<rgba_t> color_border_focused{ "zk.style.window-header.color.border.active", "ff9900ff" };
