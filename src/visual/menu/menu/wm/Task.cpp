...
static settings::RVariable<rgba_t> color_hovered{ "zk.style.task.color.background.hover", "804d00ff" };
static settings::RVariable<rgba_t> color_border{ "zk.style.task.color.border", "ffaa00ff" };
